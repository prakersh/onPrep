"""Tests for C intermediate-level seed JSON files (08-11).
...
REQUIRED_FILES = {
    '08_advanced_pointers.json': {
        'concept_slug': 'advanced-pointers',
        'expected_count': 15,
        'difficulty': 'intermediate',
    },
    '09_dynamic_memory.json': {
        'concept_slug': 'dynamic-memory',
        'expected_count': 15,
        'difficulty': 'intermediate',
    },
    '10_structures_unions_enums.json': {
        'concept_slug': 'structures-unions-enums',
        'expected_count': 15,
        'difficulty': 'intermediate',
    },
    '11_file_io_ansi.json': {
        'concept_slug': 'file-io-ansi',
        'expected_count': 12,
        'difficulty': 'intermediate',
    },
}
