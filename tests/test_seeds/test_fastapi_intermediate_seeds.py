"""Tests to validate FastAPI intermediate seed JSON files conform to the expected schema and quality standards."""
...
EXPECTED_FILES = [
    ('04_pydantic_validation.json', 'pydantic-validation', 18),
    ('05_async_programming.json', 'async-programming', 15),
    ('06_dependency_injection.json', 'dependency-injection', 15),
    ('07_security_authentication.json', 'security-authentication', 18),
    ('08_middleware_cors.json', 'middleware-cors', 12),
    ('09_error_handling.json', 'error-handling', 12),
    ('10_database_integration.json', 'database-integration', 15),
    ('11_testing.json', 'testing', 15),
]
...
class TestFastAPIIntermediateFilesExist:
    """Verify all 8 intermediate seed files exist and are valid JSON."""
...
class TestFastAPIIntermediateSchema:
...
class TestFastAPIIntermediateAnswers:
