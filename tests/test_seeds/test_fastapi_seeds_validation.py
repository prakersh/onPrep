"""Tests to validate FastAPI beginner seed JSON files conform to the expected schema and quality standards."""
...
EXPECTED_FILES = [
    ('01_core_fundamentals.json', 'core-fundamentals', 15),
    ('02_routing_path_operations.json', 'routing-path-operations', 15),
    ('03_request_response.json', 'request-response', 18),
]
...
class TestFastAPIBeginnerFilesExist:
    """Verify all 3 beginner seed files exist and are valid JSON."""
...
class TestFastAPIBeginnerSchema:
...
class TestFastAPIBeginnerAnswers:
